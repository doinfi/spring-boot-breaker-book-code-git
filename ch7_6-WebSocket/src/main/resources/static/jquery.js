                    ...
                    if (match && (match[1] || !context)) {
                        ...
                        if (match[1]) {
                            ...
                            if (ret) {
                                ...
                                selector = (ret.cacheable ? jQuery.clone(
                                    ret.fragment) : ret.fragment).childNodes;
                            }
...
// Give the init function the jQuery prototype for later instantiation
        ...
        jQuery.extend({
            ...
            type: function (obj) {
                return obj == null ? String(obj) : class2type[toString.call(
                    obj)] || "object";
            },
    ...
    jQuery.extend({
        ...
        Deferred: function (func) {
            ...
            jQuery.extend(deferred, {
                ...
                always: function () {
                    return deferred.done.apply(deferred, arguments).fail.apply(
                        this, arguments);
                },
                                ...
                                deferred[handler](function () {
                                    ...
                                    if (returned && jQuery.isFunction(
                                        ...
                                        returned.promise().then(
                                            newDefer.resolve, newDefer.reject);
                                    } else {
        ...
        when: function (firstParam) {
            var args = arguments,
                ...
                deferred = length <= 1 && firstParam && jQuery.isFunction(
                    firstParam.promise) ? firstParam : jQuery.Deferred();

            function resolveFunc(i) {
                return function (value) {
                    args[i] = arguments.length > 1 ? sliceDeferred.call(
                        arguments, 0) : value;
                    if (!( --count )) {
                        // Strange bug in FF4:
    ...
    jQuery.extend({
        ...
        data: function (elem, name, data, pvt /* Internal Use Only */) {
            ...
            var internalKey = jQuery.expando,
                getByName = typeof name === "string", thisCache,
            ...
            if (typeof data === "string") {
                try {
                    data = data === "true" ? true : data === "false" ? false
                        : data === "null" ? null : !jQuery.isNaN(data)
                            ? parseFloat(data) : rbrace.test(data)
...
// order to make sure JSON.stringify does not expose internal metadata
    ...
    function handleQueueMarkDefer(elem, type, src) {
        ...
        if (defer &&
            ( src === "queue" || !jQuery.data(elem, queueDataKey, undefined,
                true) ) &&
            ( src === "mark" || !jQuery.data(elem, markDataKey, undefined,
                true) )) {
    ...
    jQuery.extend({
        ...
        _unmark: function (force, elem, type) {
            ...
            if (elem) {
                type = type || "fx";
                var key = type + "mark",
                    count = force ? 0 : ( (jQuery.data(elem, key, undefined,
                        true) || 1 ) - 1 );
                if (count) {
        ...
        promise: function (type, object) {
            ...
            while (i--) {
                if (( tmp = jQuery.data(elements[i], deferDataKey, undefined,
                        true) ||
                        ( jQuery.data(elements[i], queueDataKey, undefined,
                            true) ||
                            jQuery.data(elements[i], markDataKey, undefined,
                                true) ) &&
                ...
                for (var i = 0, l = this.length; i < l; i++) {
                    ...
                    if (elem.nodeType === 1) {
                        if (!elem.className) {
                            ...
                            for (var c = 0, cl = classNames.length; c < cl;
                                c++) {
                ...
                get: function (elem) {
                    ...
                    for (var i = one ? index : 0,
                        ...
                        if (option.selected && (jQuery.support.optDisabled
                                ? !option.disabled : option.getAttribute(
                                "disabled") === null) &&
            ...
            tabIndex: {
                get: function (elem) {
                    ...
                    return attributeNode && attributeNode.specified ? parseInt(
                        attributeNode.value, 10) : rfocusable.test(
...
// Create "bubbling" focus and blur events
    ...
    function liveHandler(event) {
        ...
        if (event.liveFired === this || !events || !events.live
            || event.target.disabled || event.button && event.type
            === "click") {
            return;
        }
    ...
    function liveConvert(type, selector) {
        return (type && type !== "*" ? type + "." : "") + selector.replace(
            rperiod, "`").replace(rspaces, "&");
    }
    ...
    jQuery.each(
        ...
        function (i, name) {
            ...
            jQuery.fn[name] = function (data, fn) {
                ...
                return arguments.length > 0 ? this.bind(name, data, fn)
                    : this.trigger(name);
            };
        ...
        var Expr = Sizzle.selectors = {
                ...
                "+": function (checkSet, part) {
                    ...
                    for (var i = 0, l = checkSet.length, elem; i < l; i++) {
                        if ((elem = checkSet[i])) {
                            ...
                            && elem.nodeName.toLowerCase() === part ? elem
                                || false : elem === part;
                        }
                    }
            ...
            filters: {
                ...
                text: function (elem) {
                    ...
                    return elem.nodeName.toLowerCase() === "input" && "text"
            ...
            filter: {
                PSEUDO: function (elem, match, i, array) {
                    ...
                    if (filter) {
                        ...
                        return (elem.textContent || elem.innerText
                            || Sizzle.getText([elem]) || "").indexOf(match[3])
                            >= 0;
                ...
                ATTR: function (elem, match) {
                    ...
                    return result == null ? type === "!=" : type === "=" ? value
                        === check : type === "*=" ? value.indexOf(check) >= 0
                        : type === "~=" ? (" " + value + " ").indexOf(check)
                            >= 0 : !check ? value && result !== false : type
                        === "!=" ? value !== check : type === "^="
                        ...
                        try {
                            if (pseudoWorks || !Expr.match.PSEUDO.test(expr)
                                ...
                                if (ret || !disconnectedMatch ||
                                    ...
                                    node.document && node.document.nodeType
                                    !== 11) {
                                    return ret;
                                }
                            }
...
// EXPOSE
    ...
    jQuery.fn.extend({
        ...
        is: function (selector) {
            return !!selector && ( typeof selector === "string" ? jQuery.filter(
        ...
        html: function (value) {
            if (value === undefined) {
                return this[0] && this[0].nodeType === 1
                    ? this[0].innerHTML.replace(rinlinejQuery, "") : null;
        ...
        domManip: function (args, table, callback) {
            ...
            if (this[0]) {
                ...
                if (first) {
                    ...
                    for (var i = 0, l = this.length, lastIndex = l - 1; i < l;
                        i++) {
                        callback.call(
                ...
                for (i = 0; ret[i]; i++) {
                    if (scripts && jQuery.nodeName(ret[i], "script")
                        && (!ret[i].type || ret[i].type.toLowerCase()
                            === "text/javascript")) {
                        scripts.push(
                            ret[i].parentNode ? ret[i].parentNode.removeChild(
                                ret[i]) : ret[i]);
        ...
        ajax: function (url, options) {
            ...
            var // Create the final options object
                ...
                ( callbackContext.nodeType || callbackContext
                    instanceof jQuery ) ? jQuery(callbackContext)
                    : jQuery.event,
                // Deferreds
            ...
            function done(status, statusText, responses, headers) {
                ...
                var isSuccess,
                    success,
                    error,
                    response = responses ? ajaxHandleResponses(s, jqXHR,
                        responses) : undefined,
                    lastModified,
                    etag;
                ...
                if (status >= 200 && status < 300 || status === 304) {
                    ...
                    if (s.ifModified) {
                        ...
                        if (( lastModified = jqXHR.getResponseHeader(
                                "Last-Modified") )) {
            ...
            if (speed || speed === 0) {
                ...
                for (var i = 0, j = this.length; i < j; i++) {
                    ...
                    if (elem.style) {
                        ...
                        if (!jQuery._data(elem, "olddisplay") && display
                            === "none") {
                            display = elem.style.display = "";
                        }
            ...
            if (speed || speed === 0) {
                ...
                for (var i = 0, j = this.length; i < j; i++) {
                    if (this[i].style) {
                        ...
                        if (display !== "none" && !jQuery._data(this[i],
                                "olddisplay")) {
                ...
                for (p in prop) {
                    ...
                    if (rfxtypes.test(val)) {
                        ...
                        if (parts) {
                            ...
                            unit = parts[3] || ( jQuery.cssNumber[p] ? ""
                                : "px" );
    ...
    if ("getBoundingClientRect" in document.documentElement) {
        ...
        jQuery.fn.offset = function (options) {
            ...
            var computedStyle,
                ...
                prevComputedStyle = defaultView ? defaultView.getComputedStyle(
...
// Create innerHeight, innerWidth, outerHeight and outerWidth methods
    jQuery.each(["Height", "Width"], function (i, name) {
        ...
        jQuery.fn["outer" + name] = function (margin) {
            return this[0] ? parseFloat(
                jQuery.css(this[0], type, margin ? "margin" : "border")) : null;
        };
